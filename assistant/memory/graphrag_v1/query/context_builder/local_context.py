...
from assistant.memory.graphrag_v1.query.input.retrieval.entities import to_entity_dataframe
from assistant.memory.graphrag_v1.model import (
    Entity,
    Covariate,
    Relationship,
)
from assistant.memory.graphrag_v1.query.input.retrieval.covariates import (
    to_covariate_dataframe,
    get_candidate_covariates,
)
from assistant.memory.graphrag_v1.query.input.retrieval.relationships import (
...
def build_entity_context(
    ...
    for entity in selected_entities:
        ...
        for filed in attribute_cols:
            field_value = (
                str(entity.attributes.get(filed))
                if entity.attributes and entity.attributes.get(filed)
                else ""
            )
