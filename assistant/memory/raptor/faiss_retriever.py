...
class FaissRetrieverConfig:
    def __init__(
        ...
        if max_content_tokens is not None and max_content_tokens < 1:
            raise ValueError("max_content_tokens must be at least 1 or None")
    ...
    def log_config(self):
        ...
        """.format(
            ...
            max_context_tokens=self.max_content_tokens,
...
class FaissRetriever(BaseRetriever):
    ...
    def build_from_text(self, doc_text):
        ...
        with ProcessPoolExecutor() as executor:
            ...
            for future in tqdm(futures, total=len(futures), desc="Building embedding"):
    ...
    def sanity_check(self, num_samples=4):
        ...
        for i in indices:
            ...
            ), f"Embedding do not match for index {i}!"
